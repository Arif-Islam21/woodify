    ...
    <Fade duration={3000}>
      <div className="px-4 lg:px-12 py-8 bg-[#795548]">
        ...
        <div className="collapse collapse-arrow bg-[#613829e2] text-white">
          ...
          <div className="collapse-content">
            <p className="max-w-2xl">
              Surely we have a refund policy. you can check the wood before
              buying . but if you face any porblem after buying the wood you can
              easyly return the wood to us. If you want to know more about this.
