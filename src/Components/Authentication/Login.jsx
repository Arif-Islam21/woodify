...
const Login = () => {
  ...
  return (
    <div className="dark:bg-[#79554883] dark:text-white min-h-screen">
      <div className="w-full max-w-sm my-12 p-6 m-auto mx-auto bg-white rounded-lg shadow-md dark:bg-gray-800">
        ...
        <div className="flex items-center mt-6 -mx-2">
          <button
            onClick={googleLogin}
            type="button"
            className="flex items-center justify-center w-full px-6 py-2 mx-2 text-sm font-medium text-white transition-colors duration-300 transform bg-[#795548] rounded-lg hover:bg-[#7955489d] focus:outline-none"
          >
          ...
          <button
            onClick={githubLogin}
            className="p-2 mx-2 text-sm font-medium text-white transition-colors duration-300 transform bg-[#795548] rounded-lg hover:bg-[#7955489d]"
          >
